...
为了保持项目架构的一致性与长期可维护性，本项目目前不鼓励公开 Fork 或公开衍生版本。

- 允许：用户在本地环境中出于学习、调试或个人使用目的，对项目进行 Fork 或修改。
- 暂不支持：将本项目或修改版本作为 公开仓库 / 镜像 / 衍生项目 发布。

若您希望基于本项目进行进一步开发或合作，请随时通过邮件联系作者 ARC，我们非常欢迎交流。
